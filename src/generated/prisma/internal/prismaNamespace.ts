		...
		Availability: {
			...
			operations: {
				...
				count: {
					...
					result:
						| runtime.Types.Utils.Optional<Prisma.AvailabilityCountAggregateOutputType>
						| number;
				};
			};
		};
		...
		TechnicianProfile: {
			...
			operations: {
				...
				count: {
					...
					result:
						| runtime.Types.Utils.Optional<Prisma.TechnicianProfileCountAggregateOutputType>
						| number;
				};
			};
		};
...
export type TechnicianProfileScalarFieldEnum =
	(typeof TechnicianProfileScalarFieldEnum)[keyof typeof TechnicianProfileScalarFieldEnum];
